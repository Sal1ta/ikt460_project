...
# Axial coordinates have six natural neighbours shared by every move search
...
class BoardPosition:
    ...
    def __init__(self, q, r, spacing, postype='board'):
        ...
        # Rules use axial coordinates, while the GUI uses precomputed pixel coordinates
...
class Pin:
    ...
    def get_possible_moves(self):
        ...
        # Hop search is where most of the rule complexity lives It explores all
        # reachable landing cells, but each landing cell is only expanded once
        # to avoid looping forever through the same jump cycle
    ...
    def place_pin(self, destination_cell: int):
        ...
        # Moving a pin updates occupancy, the pin index, and the destination cell
