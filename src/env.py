...
class ChineseCheckersEnv:
    ...
    def total_distance_to_target(self, player_color):
        # Match each unfinished pin to a separate target cell for realistic endgame scoring
    ...
    def get_target_positions(self, player_color):
        # A players goal is always the opposite home triangle
    ...
    def evaluate_action_progress(self, action, player_color):
        # Simple progress scorer reduce assignment distance, reward goal entry,
        # and penalize pulling finished pins out or repeating cycles
        pin_id, destination_cell = action
