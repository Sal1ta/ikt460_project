...
# Training writes into these folders repeatedly constants keep paths centralized
...
AFTERSTATE_TWOPLAYER_MODEL = AFTERSTATE_MODEL_DIR / "twoplayer.pth"
AFTERSTATE_MULTIPLAYER_MODEL = AFTERSTATE_MODEL_DIR / "multiplayer.pth"
AFTERSTATE_EXTERNAL_MODEL = AFTERSTATE_MODEL_DIR / "external.pth"
